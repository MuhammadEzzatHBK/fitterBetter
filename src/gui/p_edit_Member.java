 ...
 * @author user
 */
public class p_edit_Member extends javax.swing.JPanel {

    /**
     * Creates new form p_edit_Member
     */
    general_login f;
    public p_edit_Member() {
        initComponents();
    }
    public p_edit_Member(general_login f) {
        initComponents();
        this.f =f;
    }
    /**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Dashboard_Physician d = new Dashboard_Physician(f);
        f.add(d);
