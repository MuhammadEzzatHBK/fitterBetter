...
public class meal {
    ...
    public meal(String name,double portion_amount, String portion_name, double grain,double vegetable,double fruit,double milk,double meat,double alcohol,double calories) 
    {
        this.name = name;
